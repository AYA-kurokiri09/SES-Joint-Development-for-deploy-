...
<head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# article: http://ogp.me/ns/article#">
  ...
  <link rel="canonical" href="https://ses-joint-development.herokuapp.com/" />
  <link rel="icon" type="image/png" href="ファビコンのパス" />
  <!-- OGP設定 -->
  <meta property="og:type" content="SE2-Site" />
  <meta property="og:url" content="https://ses-joint-development.herokuapp.com/" />
  <meta property="og:image" content="img/SE2.png" />
  <meta property="og:title" content="SE2 -Study English Site for Engineers-" />
  <meta property="og:description" content="プログラミング言語別に英語が学べるサイトです" />
  <!-- スタイルシートはここから -->
  ...
  <div id="global-container">
    <div id="container">
          ...
          <section class="questions">
            ...
            <div class="questions__select">
              ...
              <div class="questions__type">
                <span>記述式</span>
                <div class="questions__start">
                  <a href="quizJSchoise_DB/commingsoon.php" class="btn btn-default btn-lg">準備中</a>
                </div>
              </div>
            </div>
          ...
          <div id="footer-index" class="row pt-1">
            ...
            <li class="staff-name"><span></span>JUN</li>
                <ul class="list-unstyled">
                  ...
                  <li>
                    <a href="https://github.com/JUN-work" target="_blank" rel="noopener noreferrer">
                      GitHub
                    </a>
                  </li>
                </ul>
            ...
            <li class="staff-name"><span></span>Yuki.Ishizaki</li>
              <li>
                <ul class="list-unstyled">
                  <li>
                    <a href="https://twitter.com/zakky0519" target="_blank" rel="noopener noreferrer">
                      Twitter
                    </a>
                  </li>
                  <li>
                    <a href="https://github.com/YukiIshizaki0525" target="_blank" rel="noopener noreferrer">
                      GitHub
                    </a>
                  </li>
                </ul>
            ...
            <li class="staff-name"><span></span>そってぃ</li>
              <li>
                <ul class="list-unstyled">
                  <li>
                    <a href="https://twitter.com/sohhprog" target="_blank" rel="noopener noreferrer">
                      Twitter
                    </a>
                  </li>
                  <li>
                    <a href="https://github.com/sohh85" target="_blank" rel="noopener noreferrer">
                      GitHub
                    </a>
                  </li>
                </ul>
            ...
            <li class="staff-name"><span></span>綾</li>
              <li>
                <ul class="list-unstyled">
                  <li>
                    <a href="https://twitter.com/yanagi4939" target="_blank" rel="noopener noreferrer">
                      Twitter
                    </a>
                  </li>
                  <li>
                    <a href="https://github.com/AYA-kurokiri09" target="_blank" rel="noopener noreferrer">
                      GitHub
                    </a>
                  </li>
                </ul>
            ...
            <ul class="col list-unstyled">
              <li>
                <button type="button" id="contact_btn" class="btn btn-info">
                  <a href="./contact/contact_top.php" class="contact_font">お問い合わせはこちら</a>
                </button>
              </li>
              //contactフォルダ内のcontact_top.php(お問い合わせページテンプレ)に飛びます
            </ul>
            -->
      ...
      <nav class="mobile-menu">
        <div class="logo">
          <img src="img/SE2.png" alt="SE2" />
        </div>
        <ul class="mobile-menu__main">
          <li class="mobile-menu__item">
            <a href="register.php" class="mobile-menu__link">
              <span class="mobile-menu__title">新規登録</span>
            </a>
          </li>
          <li class="mobile-menu__item">
            <a href="login.php" class="mobile-menu__link">
              <span class="mobile-menu__title">ログイン</span>
            </a>
          </li>
        </ul>
      </nav>
